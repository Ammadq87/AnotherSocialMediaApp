export const uiConstants = {
  ...
  btn: {
    primaryBtn:
      "bg-primary w-24 text-xl font-bold px-4 py-1 rounded-md text-white hover:bg-secondary",
    secondaryBtn:
      "bg-secondary-bg w-24 text-xl font-bold px-4 py-1 rounded-md text-white hover:underline",
    disabledBtn:
